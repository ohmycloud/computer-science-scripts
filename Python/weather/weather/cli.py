...
@click.option("--latitude", "-lat", default=39.9042, type=float, required=False, help="latitude (in degrees)")
@click.option("--longitude", "-lon", default=116.4074, type=float, required=False, help="longitude (in degrees)")
